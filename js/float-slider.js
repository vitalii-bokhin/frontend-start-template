var FlSlider = {
	...
	init: function() {
		...
		$('.float-slider__float-item').first().addClass('float-slider__float-item_curr').next('.float-slider__float-item').addClass('float-slider__float-item_next');
	...
	line: function() {
		var _ = this;
		/*$('.float-slider-control__line span').stop().css('width', 0);
		$('.float-slider-control__btn_active .float-slider-control__line span').stop().animate({width: '100%'}, 5000, 'linear', function() {
			//
		});*/
