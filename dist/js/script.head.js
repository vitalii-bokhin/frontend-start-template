...
(function () {
  'use strict'; // WebP Support Checkout
  ...
  var wasWepbChecked = false,
      webpCheckResult = void 0;

  isWebpSupport = function isWebpSupport(callback) {
    if (wasWepbChecked) {
...
(function () {
  ...
  fixHeader();
  window.addEventListener('scroll', fixHeader); //mob menu
