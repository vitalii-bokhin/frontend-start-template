...
var ValidateForm;!function(){"use strict";ValidateForm={input:null,errorTip:function(t,e){var r=this.input.closest(".form__field"),i=r.querySelector(".form__error-tip");t?(r.classList.add("form__field_error"),e&&(i.getAttribute("data-error-text")||i.setAttribute("data-error-text",i.innerHTML),i.innerHTML=i.getAttribute("data-error-text-"+e))):r.classList.remove("form__field_error")},customErrorTip:function(t,e){var r=this;r.$input=t,r.errorTip(!0,"custom",e)},date:function(){var t=!1;return function(t){var e=new RegExp("^([0-9]{2}).([0-9]{2}).([0-9]{4})$"),r=e.exec(t);if(!r)return!1;var i=new Date,a=new Date(r[3],r[2]-1,r[1]);return a.getMonth()==r[2]-1&&a.getDate()==r[1]&&a.getFullYear()==r[3]&&a.valueOf()<i.valueOf()}(this.input.value)?this.errorTip(!1):(this.errorTip(!0,2),t=!0),t},email:function(){var t=!1;return/^[a-z0-9]+[\w\-\.]*@[\w\-]{2,}\.[a-z]{2,6}$/i.test(this.input.value)?this.errorTip(!1):(this.errorTip(!0,2),t=!0),t},tel:function(){var t=!1;return/^\+7\([0-9]{3}\)[0-9]{3}-[0-9]{2}-[0-9]{2}$/.test(this.input.value)?this.errorTip(!1):(this.errorTip(!0,2),t=!0),t},pass:function(){var t=!1,e=this.input.getAttribute("data-min-length");return e&&this.input.value.length<e?(this.errorTip(!0,2),t=!0):this.errorTip(!1),t},select:function(t){var e=!1;return this.input=t,t.getAttribute("data-required")&&!t.value.length?(this.errorTip(!0),e=!0):this.errorTip(!1),e},validateOnInputOrBlur:function(t){var e=t.target.closest('input[type="text"], input[type="password"], textarea');if(e){if(this.input=e,"blur"==t.type)e.setAttribute("data-tested","true");else if("input"==t.type&&!e.getAttribute("data-tested"))return;var r=e.getAttribute("data-type"),i=e.value;e.getAttribute("data-required")&&!i.length?this.errorTip(!0):i.length&&r?this[r]():this.errorTip(!1)}},file:function(t){if(t){var e=t.target.closest('input[type="file"]');if(!e)return;this.input=e}for(var r=!1,i={type:0,size:0},a=this.input.files,n=this.input.getAttribute("data-type"),u=+this.input.getAttribute("data-max-size"),o=0;o<a.length;o++){var s=a[o];s.type.match(n)?s.size>u&&i.size++:i.type++}return i.type?(this.errorTip(!0,2),r=!0):i.size?(this.errorTip(!0,3),r=!0):this.errorTip(!1),r},validate:function(t){function e(t){for(var e=!1;t&&t;){var r=getComputedStyle(t);if("none"==r.display||"hidden"==r.visibility||"0"==r.opacity){e=!0;break}t=t.parentElement}return e}for(var r=0,i=t.querySelectorAll('input[type="text"], input[type="password"], textarea'),a=0;a<i.length;a++){var n=i[a];if(!e(n)){this.input=n,n.setAttribute("data-tested","true");var u=n.getAttribute("data-type");n.value.length?u&&this[u]()&&r++:n.getAttribute("data-required")?(this.errorTip(!0),r++):this.errorTip(!1)}}for(var i=t.querySelectorAll(".custom-select__input"),a=0;a<i.length;a++){var n=i[a];e(n.parentElement)||this.select(n)&&r++}for(var i=t.querySelectorAll('input[type="checkbox"]'),a=0;a<i.length;a++){var n=i[a];e(n)||(this.input=n,n.getAttribute("data-required")&&!n.checked?(this.errorTip(!0),r++):this.errorTip(!1))}for(var o=t.querySelectorAll(".form__chbox-group"),a=0;a<o.length;a++){var s=o[a],p=0;if(!e(s)){var i=s.querySelectorAll('input[type="checkbox"]');i.forEach(function(t){t.checked&&p++}),p<s.getAttribute("data-min")?(s.classList.add("form__chbox-group_error"),r++):s.classList.remove("form__chbox-group_error")}}for(var o=t.querySelectorAll(".form__radio-group"),a=0;a<o.length;a++){var s=o[a],l=!1;if(!e(s)){var i=s.querySelectorAll('input[type="radio"]');i.forEach(function(t){t.checked&&(l=!0)}),l?s.classList.remove("form__radio-group_error"):(s.classList.add("form__radio-group_error"),r++)}}for(var i=t.querySelectorAll('input[type="file"]'),a=0;a<i.length;a++){var n=i[a];e(n)||(this.input=n,n.files.length?this.file()&&r++:n.getAttribute("data-required")?(this.errorTip(!0),r++):this.errorTip(!1))}return!r},actSubmitBtn:function(t,e){var r=$(t).find('button[type="submit"], input[type="submit"]');r.is(":hidden")||(e?r.prop("disabled",!1):r.prop("disabled",!0))},clearForm:function(t){var e=$(t);e.find('input[type="text"], input[type="password"], textarea').val(""),e.find(".custom-placeholder").attr("style",""),e.find(".form__textarea-mirror").html("")},submit:function(t){return this.validate(t)},init:function(t){t.addEventListener("input",this.validateOnInputOrBlur.bind(this)),t.addEventListener("blur",this.validateOnInputOrBlur.bind(this),!0),t.addEventListener("change",this.file.bind(this))}}}();
