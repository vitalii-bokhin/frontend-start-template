var winW,winH,isHidden;!function(){"use strict";document.documentElement.setAttribute("data-useragent",navigator.userAgent),winW=window.innerWidth,winH=window.innerHeight,window.addEventListener("winResized",function(){winW=window.innerWidth,winH=window.innerHeight});try{new CustomEvent("IE has CustomEvent, but doesn't support constructor")}catch(t){window.CustomEvent=function(t,e){var n;return e=e||{bubbles:!1,cancelable:!1,detail:void 0},n=document.createEvent("CustomEvent"),n.initCustomEvent(t,e.bubbles,e.cancelable,e.detail),n},CustomEvent.prototype=Object.create(window.Event.prototype)}var t=new CustomEvent("winResized"),e=!0;window.addEventListener("resize",function(){e&&(e=!1,setTimeout(function(){window.dispatchEvent(t),e=!0},1021))}),Element.prototype.closest||function(t){t.matches=t.matches||t.mozMatchesSelector||t.msMatchesSelector||t.oMatchesSelector||t.webkitMatchesSelector,t.closest=t.closest||function(t){return this?this.matches(t)?this:this.parentElement?this.parentElement.closest(t):null:null}}(Element.prototype),isHidden=function(t){if(t){for(var e=!1;t&&t;){var n=getComputedStyle(t);if("none"==n.display||"hidden"==n.visibility||"0"==n.opacity){e=!0;break}t=t.parentElement}return e}}}();
...
function CustomFile(){function e(e,t){var l=s.$field.find(".custom-file__preview").eq(t);if(e.type.match("image")){var a=new FileReader;a.onload=function(e){l.html('<img src="'+e.target.result+'" class="cover-img">'),setTimeout(function(){coverImg(".custom-file__item")},721)},a.readAsDataURL(e)}else l.html('<img src="images/preview.svg" class="full-width-img">')}function t(t){var l=$(t),a=l[0].files,o=l.siblings(".custom-file__items");s.$field=l.closest(".custom-file"),o.empty();for(var c=0;c<a.length;c++)o.append('<div class="custom-file__item"><div class="custom-file__preview cover-img-wrap"></div><div class="custom-file__name">'+a[c].name+"</div></div>"),e(a[c],c)}var s=this;s.$field=null,$("body").on("change",'input[type="file"]',function(){t(this)})}var CustomPlaceholder={init:function(e){document.querySelectorAll(e).forEach(function(e,t){if(e.placeholder){var s=e.id?e.id:"placeholder-index-"+t,l=document.createElement("label");l.htmlFor=s,l.className="custom-placeholder",l.innerHTML=e.placeholder,e.parentElement.insertBefore(l,e),e.removeAttribute("placeholder"),e.id||(e.id=s)}""!=e.value&&this.hidePlaceholder(e,!0)}),document.addEventListener("focus",function(t){var s=t.target.closest(e);s&&this.hidePlaceholder(s,!0)}.bind(this),!0),document.addEventListener("blur",function(t){var s=t.target.closest(e);s&&this.hidePlaceholder(s,!1)}.bind(this),!0)},hidePlaceholder:function(e,t){var s=document.querySelector('label[for="'+e.id+'"]');if(s){var l=s.style;t?(l.textIndent="-9999px",l.paddingLeft="0",l.paddingRight="0"):""==e.value&&(l.textIndent="0",l.paddingLeft="",l.paddingRight="")}}},CustomSelect={$field:null,close:function(){$(".custom-select").removeClass("custom-select_opened"),$(".custom-select__options").slideUp(221).find("li").removeClass("hover")},open:function(e){$(e).closest(".custom-select").addClass("custom-select_opened").find(".custom-select__options").slideDown(221).animate({scrollTop:0},0)},selectVal:function(e){var t=this,s=$(e),l=s.closest(".custom-select"),a=l.find(".custom-select__button"),o=l.find(".custom-select__input");if(l.hasClass("custom-select_multiple")){var c=[],i=[],n=l.find(".custom-select__multiple-inputs");if(s.hasClass("custom-select__val_checked")?s.removeClass("custom-select__val_checked"):s.addClass("custom-select__val_checked"),l.find(".custom-select__val_checked").each(function(e){var t=$(this);c[e]=t.html(),i[e]=void 0!=t.attr("data-value")?t.attr("data-value"):t.html()}),c.length){if(a.html(c.join(", ")),o.val(i[0]),n.empty(),i.length>1)for(var d=1;d<i.length;d++)n.append('<input type="hidden" name="'+o.attr("name")+'" value="'+i[d]+'">')}else a.html(a.attr("data-placeholder")),o.val(""),t.close()}else{var c=s.html(),i=void 0!=s.attr("data-value")?s.attr("data-value"):s.html();l.find(".custom-select__val").removeClass("custom-select__val_checked"),s.addClass("custom-select__val_checked"),a.html(c),o.val(i),CustomPlaceholder.hidePlaceholder(o,!0),t.close()}l.find(".custom-select__val").each(function(){if(_$=$(this),targetElements=_$.attr("data-target-elements"),targetElements){var e=$(targetElements);_$.hasClass("custom-select__val_checked")?e.show():e.hide()}}),o.hasClass("var-height-textarea__textarea")&&varHeightTextarea.setHeight(o),l.addClass("custom-select_changed"),ValidateForm.select(o.get()[0])},autocomplete:function(e){var t=$(e).closest(".custom-select"),s=$(e).val(),l=!1,a=new RegExp(s,"gi");t.find(".custom-select__val").each(function(){var e=$(this);e.html().match(a)?(e.parent().removeClass("hidden"),l=!0):e.parent().addClass("hidden")}),l||t.find(".custom-select__options li").removeClass("hidden")},setOptions:function(e,t,s,l){for(var a=$(e).find(".custom-select__options"),o=0;o<t.length;o++)a.append('<li><button type="button" class="custom-select__val" data-value="'+t[o][s]+'">'+t[o][l]+"</button></li>")},keyboard:function(e,t){var s=$(e).find(".custom-select__options"),l=s.find("li.hover");switch(t){case 40:if(l.length){var a=l.nextAll("li:visible").first();a.length&&(l.removeClass("hover"),a.addClass("hover"),s.stop().animate({scrollTop:s.scrollTop()+a.position().top},121))}else s.find("li:visible").first().addClass("hover");break;case 38:var a=l.prevAll("li:visible").first();a.length&&(l.removeClass("hover"),a.addClass("hover"),s.stop().animate({scrollTop:s.scrollTop()+a.position().top},121));break;case 13:this.selectVal(l.find(".custom-select__val"))}},fillAcHead:function(){var e=this;$(".custom-select__autocomplete").each(function(){var t=$(this),s=t.closest(".custom-select").find(".custom-select__val_checked");s.length&&e.selectVal(s)})},init:function(e){var t=this;$(e).each(function(){for(var e=$(this),t=e.find("option"),s=e.parent(),l="",a=void 0!=e.attr("data-required")?' data-required="'+e.attr("data-required")+'" ':"",o="autocomplete"==e.attr("data-type")?'<input type="text" name="'+e.attr("name")+'"'+a+'placeholder="'+e.attr("data-placeholder")+'" class="custom-select__input custom-select__autocomplete form__text-input" value="">':'<button type="button" data-placeholder="'+e.attr("data-placeholder")+'" class="custom-select__button">'+e.attr("data-placeholder")+"</button>",c={class:void 0!=e.attr("multiple")?" custom-select_multiple":"",inpDiv:void 0!=e.attr("multiple")?'<div class="custom-select__multiple-inputs"></div>':""},i="autocomplete"!=e.attr("data-type")?'<input type="hidden" name="'+e.attr("name")+'"'+a+'class="custom-select__input" value="">':"",n=0;n<t.length;n++){var d=$(t[n]);l+='<li><button type="button" class="custom-select__val"'+(void 0!=d.attr("value")?' data-value="'+d.attr("value")+'"':"")+(void 0!=d.attr("data-target-elements")?' data-target-elements="'+d.attr("data-target-elements")+'"':"")+">"+d.html()+"</button></li>"}s.prepend('<div class="custom-select'+c.class+'">'+o+'<ul class="custom-select__options">'+l+"</ul>"+i+c.inpDiv+"</div>"),e.remove()}),$("body").on("click",".custom-select__button",function(){return $(this).closest(".custom-select").hasClass("custom-select_opened")?t.close():(t.fillAcHead(),t.close(),t.open(this)),!1}).on("click",".custom-select__val",function(){return t.selectVal(this),!1}).on("focus",".custom-select__autocomplete",function(){$(this).closest(".custom-select").hasClass("custom-select_opened")||(t.fillAcHead(),t.close(),t.open(this))}).on("input",".custom-select__autocomplete",function(){t.autocomplete(this),$(this).closest(".custom-select").hasClass("custom-select_opened")||t.open(this)}).on("keydown",".custom-select_opened",function(e){if(40==e.keyCode||38==e.keyCode||13==e.keyCode)return t.keyboard(this,e.keyCode),!1}),$(document).on("click","body",function(e){$(e.target).closest(".custom-select_opened").length||(t.fillAcHead(),t.close())})}},varHeightTextarea={setHeight:function(e){var t=$(e),s=t.val(),l=t.parent().find(".var-height-textarea__mirror");newValue=s.replace(/\n/g,"<br>"),l.html(newValue+"&nbsp;")},init:function(){var e=this;$("body").on("input",".var-height-textarea__textarea",function(){e.setHeight(this)})}};$(document).ready(function(){CustomPlaceholder.init('input[type="text"], input[type="password"], textarea'),CustomSelect.init("select"),CustomFile(),varHeightTextarea.init()});
...
$(document).ready(function(){$("label").each(function(t){var e=$(this),i=e.siblings("label"),a=e.siblings("input, textarea"),r=a.attr("id");if(!e.attr("for")){var n=r||"keylabel-"+t;e.attr("for",n),i.attr("for",n),a.attr("id",n)}}),$("body").on("change",'input[type="checkbox"]',function(){var t=$(this),e=t.attr("data-target-elements");if(e){var i=$(e);t.prop("checked")?i.show():i.hide()}}),$("body").on("change",'input[type="radio"]',function(){var t=$(this).attr("name");$('input[type="radio"][name="'+t+'"]').each(function(){var t=$(this),e=t.attr("data-target-elements");if(e){var i=$(e);t.prop("checked")?i.show():i.hide()}})}),$("body").on("click",".form__button",function(){var t=$(this),e=t.attr("data-next-fieldset-item");if(e){var i=$(e),a=t.closest(".fieldset__item");ValidateForm.validate(a)&&(a.addClass("fieldset__item_hidden"),i.removeClass("fieldset__item_hidden"))}})});var Form;!function(){"use strict";Form=function(t){function e(){r.querySelectorAll('input[type="text"], input[type="password"], textarea').forEach(function(t){t.value="",CustomPlaceholder.hidePlaceholder(t,!1)})}function i(t){r.querySelectorAll('button[type="submit"], input[type="submit"]').forEach(function(e){isHidden(e)||(t?e.removeAttribute("disabled"):e.setAttribute("disabled","disable"))})}function a(t){ValidateForm.submit(r)?(i(!1),r.classList.add("form_sending"),this.onSubmit&&(t.preventDefault(),this.onSubmit(r,function(t){t=t||{},i(t.unlockSubmitButton),r.classList.remove("form_sending"),1==t.clearForm&&e()})),r.classList.remove("form_error")):(t.preventDefault(),r.classList.add("form_error"))}this.onSubmit=null;var r=document.querySelector(t);r&&(r.addEventListener("submit",a.bind(this)),ValidateForm.init(r))}}();
