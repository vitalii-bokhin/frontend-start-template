...
var CustomPlaceholder,CustomSelect;!function(){"use strict";function e(e){for(var t=document.querySelectorAll(e),l=0;l<t.length;l++){var i=t[l],s=i.parentElement.querySelector("label"),n=i.hasAttribute("id")?i.id:"keylabel-"+l;s.hasAttribute("for")||(s.htmlFor=n,i.id=n)}}var t={change:function(e){var t=e.hasAttribute("data-target-elements")?document.querySelectorAll(e.getAttribute("data-target-elements")):{};if(t.length)for(var l=0;l<t.length;l++)t[l].style.display=e.checked?"block":"none"},init:function(){document.addEventListener("change",function(e){var t=e.target.closest('input[type="checkbox"]');t&&this.change(t)}.bind(this))}},l={change:function(e){var t=document.querySelectorAll('input[type="radio"][name="'+e.name+'"]');if(t.length)for(var l=0;l<t.length;l++){var i=t[l],s=i.hasAttribute("data-target-elements")?document.querySelectorAll(i.getAttribute("data-target-elements")):{};if(s.length)for(var n=0;n<s.length;n++)s[n].style.display=i.checked?"block":"none"}},init:function(){document.addEventListener("change",function(e){var t=e.target.closest('input[type="radio"]');t&&this.change(t)}.bind(this))}};CustomPlaceholder={init:function(e){var t=document.querySelectorAll(e);if(t.length){for(var l=0;l<t.length;l++){var i=t[l];if(i.placeholder){var s=i.id?i.id:"placeholder-index-"+l,n=document.createElement("label");n.htmlFor=s,n.className="custom-placeholder",n.innerHTML=i.placeholder,i.parentElement.insertBefore(n,i),i.removeAttribute("placeholder"),i.id||(i.id=s)}i.value.length&&this.hidePlaceholder(i,!0)}document.addEventListener("focus",function(t){var l=t.target.closest(e);l&&this.hidePlaceholder(l,!0)}.bind(this),!0),document.addEventListener("blur",function(t){var l=t.target.closest(e);l&&this.hidePlaceholder(l,!1)}.bind(this),!0)}},hidePlaceholder:function(e,t){var l=document.querySelector('label[for="'+e.id+'"]');if(l){var i=l.style;t?(i.textIndent="-9999px",i.paddingLeft="0px",i.paddingRight="0px"):e.value.length||(i.textIndent="",i.paddingLeft="",i.paddingRight="")}}},CustomSelect={field:null,close:function(){for(var e=document.querySelectorAll(".custom-select"),t=0;t<e.length;t++)e[t].classList.remove("custom-select_opened");for(var l=document.querySelectorAll(".custom-select__options li"),t=0;t<l.length;t++)l[t].classList.remove("hover")},open:function(){this.field.classList.add("custom-select_opened"),this.field.querySelector(".custom-select__options").scrollTop=0},selectMultipleVal:function(e,t,l){var i=[],s=[],n=this.field.querySelector(".custom-select__multiple-inputs");e.classList.toggle("custom-select__val_checked");for(var c=this.field.querySelectorAll(".custom-select__val_checked"),a=0;a<c.length;a++){var e=c[a];i[a]=e.innerHTML,s[a]=e.hasAttribute("data-value")?e.getAttribute("data-value"):e.innerHTML}if(i.length){if(t.innerHTML=i.join(", "),l.value=s[0],n.innerHTML="",s.length>1)for(var a=1;a<s.length;a++){var o=document.createElement("input");o.type="hidden",o.name=l.name,o.value=s[a],n.appendChild(o)}}else t.innerHTML=t.getAttribute("data-placeholder"),l.value="",this.close()},targetAction:function(){for(var e=this.field.querySelectorAll(".custom-select__val"),t=0;t<e.length;t++){var l=e[t];if(!l.hasAttribute("data-target-elements"))return;document.querySelector(l.getAttribute("data-target-elements")).style.display=l.classList.contains("custom-select__val_checked")?"block":"none"}},selectVal:function(e){var t=this.field.querySelector(".custom-select__button"),l=this.field.querySelector(".custom-select__input");if(this.field.classList.contains("custom-select_multiple"))this.selectMultipleVal(e,t,l);else{for(var i=e.innerHTML,n=e.hasAttribute("data-value")?e.getAttribute("data-value"):e.innerHTML,c=this.field.querySelectorAll(".custom-select__val"),a=0;a<c.length;a++)c[a].classList.remove("custom-select__val_checked");e.classList.add("custom-select__val_checked"),t&&(t.innerHTML=i),l.value=n,this.close(),CustomPlaceholder.hidePlaceholder(l,!0)}this.targetAction(),l.classList.contains("var-height-textarea__textarea")&&s.setHeight(l),this.field.classList.add("custom-select_changed"),ValidateForm.select(l)},autocomplete:function(e){for(var t=!1,l=new RegExp(e.value,"gi"),i=this.field.querySelectorAll(".custom-select__val"),s=0;s<i.length;s++){var n=i[s];e.value.length?n.innerHTML.match(l)?(n.parentElement.classList.remove("hidden"),t=!0):n.parentElement.classList.add("hidden"):n.classList.remove("custom-select__val_checked")}if(!t)for(var s=0;s<i.length;s++)i[s].parentElement.classList.remove("hidden")},setOptions:function(e,t,l,i){for(var s=document.querySelectorAll(e),n=0;n<s.length;n++)for(var c=s[n].querySelector(".custom-select__options"),n=0;n<t.length;n++){var a=document.createElement("li");a.innerHTML='<button type="button" class="custom-select__val" data-value="'+t[n][l]+'">'+t[n][i]+"</button>",c.appendChild(a)}},keyboard:function(e){var t=this.field.querySelector(".custom-select__options"),l=t.querySelector("li.hover");switch(e){case 40:if(l){var i=function(e){for(var t=e.nextElementSibling;t&&t;){if(!t.elementIsHidden())return t;t=t.nextElementSibling}}(l);i&&(l.classList.remove("hover"),i.classList.add("hover"),t.scrollTop=t.scrollTop+(i.getBoundingClientRect().top-t.getBoundingClientRect().top))}else for(var s=t.firstElementChild;s&&s;){if(!s.elementIsHidden()){s.classList.add("hover");break}s=s.nextElementSibling}break;case 38:if(l){var i=function(e){for(var t=e.previousElementSibling;t&&t;){if(!t.elementIsHidden())return t;t=t.previousElementSibling}}(l);i&&(l.classList.remove("hover"),i.classList.add("hover"),t.scrollTop=t.scrollTop+(i.getBoundingClientRect().top-t.getBoundingClientRect().top))}else for(var s=t.lastElementChild;s&&s;){if(!s.elementIsHidden()){s.classList.add("hover"),t.scrollTop=9999;break}s=s.previousElementSibling}break;case 13:this.selectVal(l.querySelector(".custom-select__val"))}},fillAcHead:function(){for(var e=document.querySelectorAll(".custom-select__autocomplete"),t=0;t<e.length;t++){var l=e[t],i=l.closest(".custom-select").querySelectorAll(".custom-select__val_checked");if(!i)return;if(l.value.length)for(var s=0;s<i.length;s++)this.selectVal(i[s]);else for(var s=0;s<i.length;s++)i[s].classList.remove("custom-select__val_checked")}},build:function(e){var t=document.querySelectorAll(e);if(t.length)for(var l=0;l<t.length;l++){for(var i=t[l],s=i.querySelectorAll("option"),n=i.parentElement,c="",a=i.hasAttribute("data-required")?' data-required="'+i.getAttribute("data-required")+'" ':"",o="autocomplete"==i.getAttribute("data-type")?'<input type="text" name="'+i.name+'"'+a+'placeholder="'+i.getAttribute("data-placeholder")+'" class="custom-select__input custom-select__autocomplete form__text-input" value="">':'<button type="button" data-placeholder="'+i.getAttribute("data-placeholder")+'" class="custom-select__button">'+i.getAttribute("data-placeholder")+"</button>",r={class:i.multiple?" custom-select_multiple":"",inpDiv:i.multiple?'<div class="custom-select__multiple-inputs"></div>':""},u="autocomplete"!=i.getAttribute("data-type")?'<input type="hidden" name="'+i.name+'"'+a+'class="custom-select__input" value="">':"",d=0;d<s.length;d++){var h=s[d];c+='<li><button type="button" class="custom-select__val"'+(h.hasAttribute("value")?' data-value="'+h.value+'"':"")+(h.hasAttribute("data-target-elements")?' data-target-elements="'+h.getAttribute("data-target-elements")+'"':"")+">"+h.innerHTML+"</button></li>"}n.innerHTML='<div class="custom-select'+r.class+'">'+o+'<ul class="custom-select__options">'+c+"</ul>"+u+r.inpDiv+"</div>"}},init:function(e){this.build(e),document.addEventListener("click",function(e){var t=e.target.closest(".custom-select__button");t&&(this.field=t.closest(".custom-select"),this.field.classList.contains("custom-select_opened")?this.close():(this.fillAcHead(),this.close(),this.open()))}.bind(this)),document.addEventListener("click",function(e){var t=e.target.closest(".custom-select__val");t&&(this.field=t.closest(".custom-select"),this.selectVal(t))}.bind(this)),document.addEventListener("focus",function(e){var t=e.target.closest(".custom-select__autocomplete");t&&(this.field=t.closest(".custom-select"),this.field.classList.contains("custom-select_opened")||(this.fillAcHead(),this.close(),this.open()))}.bind(this),!0),document.addEventListener("input",function(e){var t=e.target.closest(".custom-select__autocomplete");t&&(this.field=t.closest(".custom-select"),this.autocomplete(t),this.field.classList.contains("custom-select_opened")||this.open())}.bind(this)),document.addEventListener("keydown",function(e){var t=e.target.closest(".custom-select_opened");if(t){this.field=t.closest(".custom-select");var l=e.which||e.keyCode||0;40!=l&&38!=l&&13!=l||(e.preventDefault(),this.keyboard(l))}}.bind(this)),document.addEventListener("click",function(e){e.target.closest(".custom-select_opened")||(this.fillAcHead(),this.close())}.bind(this))}};var i={field:null,loadPreview:function(e,t){var l=this.field.querySelectorAll(".custom-file__preview")[t];if(e.type.match("image")){var i=new FileReader;i.onload=function(e){l.innerHTML='<img src="'+e.target.result+'" class="cover-img">',setTimeout(function(){coverImg(".custom-file__item")},721)},i.readAsDataURL(e)}else l.innerHTML='<img src="images/preview.svg" class="full-width-img">'},changeInput:function(e){this.field=e.closest(".custom-file");var t=this,l=this.field.querySelector(".custom-file__items");l.innerHTML="",console.log(e.files);for(var i=0;i<e.files.length;i++){var s=e.files[i],n=document.createElement("div");n.className="custom-file__item",n.innerHTML='<div class="custom-file__preview cover-img-wrap"></div><div class="custom-file__name">'+s.name+"</div>",l.appendChild(n),t.loadPreview(s,i)}},init:function(){document.addEventListener("change",function(e){var t=e.target.closest('input[type="file"]');t&&this.changeInput(t)}.bind(this))}},s={setHeight:function(e){var t=e.parentElement.querySelector(".var-height-textarea__mirror"),l=e.value.replace(/\n/g,"<br>");t.innerHTML=l+"&nbsp;"},init:function(){document.addEventListener("input",function(e){var t=e.target.closest(".var-height-textarea__textarea");t&&this.setHeight(t)}.bind(this))}};document.addEventListener("DOMContentLoaded",function(){CustomSelect.init("select"),i.init(),s.init(),CustomPlaceholder.init('input[type="text"], input[type="password"], textarea'),e('input[type="checkbox"], input[type="radio"]'),t.init(),l.init()})}();
...
var Popup,MediaPopup;!function(){"use strict";Popup={winScrollTop:0,onClose:null,fixBody:function(i){i?(this.winScrollTop=window.pageYOffset,document.body.classList.add("popup-is-opened"),document.body.style.top=-this.winScrollTop+"px"):(document.body.classList.remove("popup-is-opened"),window.scrollTo(0,this.winScrollTop))},open:function(i,t){var o=document.querySelector(i);if(o&&o.classList.contains("popup__window")){var e=o.parentElement;return this.fixBody(!0),e.classList.add("popup_visible"),o.classList.add("popup__window_visible"),setTimeout(function(){CoverImg.reInit(o)},721),t&&(this.onClose=t),o}},message:function(i,t,o){this.open(i,o).querySelector(".popup__inner").innerHTML='<div class="popup__message">'+t+"</div>"},close:function(){var i=document.querySelectorAll(".popup__window");if(i.length){for(var t=0;t<i.length;t++){var o=i[t];o.classList.contains("popup__window_visible")&&(o.classList.remove("popup__window_visible"),o.parentElement.classList.remove("popup_visible"))}this.fixBody(!1),this.onClose&&(this.onClose(),this.onClose=null)}},init:function(i){document.addEventListener("click",function(t){var o=t.target.closest(i),e=t.target.closest(".popup__close");o?(t.preventDefault(),this.open(o.getAttribute("data-popup"))):!e&&t.target.closest(".popup__window")||this.close()}.bind(this))}},MediaPopup={image:function(i){var t=Popup.open(i.popupStr,function(){}),o=t.querySelector(".popup-media__image");o.src=i.href,o.classList.add("popup-media__image_visible")},video:function(i){},init:function(i){document.addEventListener("click",function(t){var o=t.target.closest(i);if(o){t.preventDefault();var e=o.getAttribute("data-type"),a={href:o.href,caption:o.getAttribute("data-caption"),group:o.getAttribute("data-group"),popupStr:o.getAttribute("data-popup")};"image"==e?this.image(a):"video"==e&&this.video(a)}}.bind(this))}}}();var pPopup={closeCallback:function(){},play:null,ind:0,group:null,position:0,show:function(i,t){var o=this,e=$(i),a=e.closest(".popup");e.length&&e.hasClass("popup__window")&&(o.position=$(window).scrollTop(),a.fadeIn(321).scrollTop(0),$(".popup__window").removeClass("popup__window_visible"),e.addClass("popup__window_visible"),$("body").css("top",-o.position).addClass("is-popup-opened"),setTimeout(function(){CoverImg.reInit("#media-popup")},721)),o.closeCallback=t||function(){}},hide:function(){var i=this;$(".popup__window").removeClass("popup__window_visible"),$(".popup").fadeOut(321),$(".popup__message").remove(),$("body").removeClass("is-popup-opened").removeAttr("style"),$("html, body").scrollTop(i.position),i.closeCallback()},message:function(i,t,o){var e=this;$(i).find(".popup__inner").prepend('<div class="popup__message">'+t+"</div>"),e.show(i),e.closeCallback=o||function(){}},media:function(i,t,o){var e=this,a=$(i).attr("data-popup"),p=$(a),s=p.find(".popup-media__box"),n=p.find(".popup-media__image"),r=p.find(".popup-media__play"),d=p.find(".popup-media__iframe");if(t.data){p.find(".popup-media__bar").css("display","block");for(var u=JSON.parse(t.data),l=0;l<u.length;l++)p.find(".popup-media__data-"+l).html(u[l])}if(t.imgSize){var c=JSON.parse(t.imgSize);n.attr("width",c[0]).attr("height",c[1])}else n.attr("width","").attr("height","");t.img&&n.css({visibility:"visible",marginLeft:"",marginTop:""}).removeClass("cover-img_w cover-img_h").attr("src",t.img),d.css("visibility","hidden").attr("src",""),r.css("visibility","hidden"),t.vid?(s.removeClass("middle").addClass("cover-img-wrap"),n.removeClass("middle__img").addClass("cover-img"),r.css("visibility","visible").attr("href",t.vid),e.play=function(){var i=t.vid.match(/(?:youtu\.be\/|youtube\.com\/watch\?v\=|youtube\.com\/embed\/)+?([\w-]+)/i),o="https://www.youtube.com/embed/"+i[1]+"?autoplay=1";r.css("visibility","hidden"),n.css("visibility","hidden"),d.css("visibility","visible").attr("src",o)},t.img?setTimeout(function(){CoverImg.init(a),n.attr("src",t.img)},721):e.play()):(s.removeClass("cover-img-wrap").addClass("middle"),n.removeClass("cover-img").addClass("middle__img")),t.group&&(p.find(".popup-media__arr").css("display","block"),e.group=$(i).attr("data-group"),e.ind=$('[data-group="'+e.group+'"]').index(i)),o&&e.show(a),e.closeCallback=function(){n.css("visibility","hidden").attr("src",""),d.css("visibility","hidden").attr("src",""),r.css("visibility","hidden")}},next:function(i){var t,o=this,e=o.ind;if("next"==i?(e++,$('[data-group="'+o.group+'"]').eq(e).length&&(t=$('[data-group="'+o.group+'"]').eq(e))):"prev"==i&&e>0&&(e--,$('[data-group="'+o.group+'"]').eq(e).length&&(t=$('[data-group="'+o.group+'"]').eq(e))),t){var a;t.hasClass("js-open-popup-image")?a={img:t.attr("href"),imgSize:t.attr("data-image-size"),group:t.attr("data-group"),data:t.attr("data-data")}:t.hasClass("js-open-popup-video")&&(a={vid:t.attr("href"),img:t.attr("data-preview"),imgSize:t.attr("data-preview-size"),group:t.attr("data-group"),data:t.attr("data-data")}),o.media(t,a)}}};$(document).ready(function(){if($("body").on("click",".js-open-popup-image",function(){var i={img:$(this).attr("href"),imgSize:$(this).attr("data-image-size"),group:$(this).attr("data-group"),data:$(this).attr("data-data")};return Popup.media(this,i,!0),!1}),$("body").on("click",".js-open-popup-video",function(){var i={vid:$(this).attr("href"),img:$(this).attr("data-preview"),imgSize:$(this).attr("data-preview-size"),group:$(this).attr("data-group"),data:$(this).attr("data-data")};return Popup.media(this,i,!0),!1}),$("body").on("click",".popup-media__play",function(){return Popup.play(),!1}),$("body").on("click",".popup-media__arr",function(){return Popup.next($(this).attr("data-dir")),!1}),$("body").on("click",".js-open-msg-popup",function(){return Popup.message("#message-popup",'Это всплывашка с сообщением.<br> вызов: <span class="c-red">Popup.message("#id", "Текст или html");</span>',function(){alert("После закрытия")}),!1}),window.location.hash){var i=window.location.hash;$(i).length&&$(i).hasClass("popup__window")&&Popup.show(i)}});
