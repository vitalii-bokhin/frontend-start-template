...
$(document).ready(function(){$("label").each(function(t){var e=$(this),a=e.siblings("label"),i=e.siblings("input, textarea"),n=i.attr("id");if(!e.attr("for")){var r=n||"keylabel-"+t;e.attr("for",r),a.attr("for",r),i.attr("id",r)}}),$("body").on("change",'input[type="checkbox"]',function(){var t=$(this),e=t.attr("data-target-elements");if(e){var a=$(e);t.prop("checked")?a.show():a.hide()}}),$("body").on("change",'input[type="radio"]',function(){var t=$(this).attr("name");$('input[type="radio"][name="'+t+'"]').each(function(){var t=$(this),e=t.attr("data-target-elements");if(e){var a=$(e);t.prop("checked")?a.show():a.hide()}})}),$("body").on("click",".form__button",function(){var t=$(this),e=t.attr("data-next-fieldset-item");if(e){var a=$(e),i=t.closest(".fieldset__item");ValidateForm.validate(i)&&(i.addClass("fieldset__item_hidden"),a.removeClass("fieldset__item_hidden"))}})});
