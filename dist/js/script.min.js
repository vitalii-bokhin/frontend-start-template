...
var Popup;!function(){"use strict";Popup={open:function(i){var t=document.querySelector(i);if(t){t.parentElement}},init:function(i){document.addEventListener("click",function(t){var a=t.target.closest(i);a&&(t.preventDefault(),this.open(a.getAttribute("data-popup")))}.bind(this))}}}();var pPopup={closeCallback:function(){},play:null,ind:0,group:null,position:0,show:function(i,t){var a=this,o=$(i),e=o.closest(".popup");o.length&&o.hasClass("popup__window")&&(a.position=$(window).scrollTop(),e.fadeIn(321).scrollTop(0),$(".popup__window").removeClass("popup__window_visible"),o.addClass("popup__window_visible"),$("body").css("top",-a.position).addClass("is-popup-opened"),setTimeout(function(){CoverImg.reInit("#media-popup")},721)),a.closeCallback=t||function(){}},hide:function(){var i=this;$(".popup__window").removeClass("popup__window_visible"),$(".popup").fadeOut(321),$(".popup__message").remove(),$("body").removeClass("is-popup-opened").removeAttr("style"),$("html, body").scrollTop(i.position),i.closeCallback()},message:function(i,t,a){var o=this;$(i).find(".popup__inner").prepend('<div class="popup__message">'+t+"</div>"),o.show(i),o.closeCallback=a||function(){}},media:function(i,t,a){var o=this,e=$(i).attr("data-popup"),p=$(e),s=p.find(".popup-media__box"),r=p.find(".popup-media__image"),d=p.find(".popup-media__play"),n=p.find(".popup-media__iframe");if(t.data){p.find(".popup-media__bar").css("display","block");for(var u=JSON.parse(t.data),l=0;l<u.length;l++)p.find(".popup-media__data-"+l).html(u[l])}if(t.imgSize){var c=JSON.parse(t.imgSize);r.attr("width",c[0]).attr("height",c[1])}else r.attr("width","").attr("height","");t.img&&r.css({visibility:"visible",marginLeft:"",marginTop:""}).removeClass("cover-img_w cover-img_h").attr("src",t.img),n.css("visibility","hidden").attr("src",""),d.css("visibility","hidden"),t.vid?(s.removeClass("middle").addClass("cover-img-wrap"),r.removeClass("middle__img").addClass("cover-img"),d.css("visibility","visible").attr("href",t.vid),o.play=function(){var i=t.vid.match(/(?:youtu\.be\/|youtube\.com\/watch\?v\=|youtube\.com\/embed\/)+?([\w-]+)/i),a="https://www.youtube.com/embed/"+i[1]+"?autoplay=1";d.css("visibility","hidden"),r.css("visibility","hidden"),n.css("visibility","visible").attr("src",a)},t.img?setTimeout(function(){CoverImg.init(e),r.attr("src",t.img)},721):o.play()):(s.removeClass("cover-img-wrap").addClass("middle"),r.removeClass("cover-img").addClass("middle__img")),t.group&&(p.find(".popup-media__arr").css("display","block"),o.group=$(i).attr("data-group"),o.ind=$('[data-group="'+o.group+'"]').index(i)),a&&o.show(e),o.closeCallback=function(){r.css("visibility","hidden").attr("src",""),n.css("visibility","hidden").attr("src",""),d.css("visibility","hidden")}},next:function(i){var t,a=this,o=a.ind;if("next"==i?(o++,$('[data-group="'+a.group+'"]').eq(o).length&&(t=$('[data-group="'+a.group+'"]').eq(o))):"prev"==i&&o>0&&(o--,$('[data-group="'+a.group+'"]').eq(o).length&&(t=$('[data-group="'+a.group+'"]').eq(o))),t){var e;t.hasClass("js-open-popup-image")?e={img:t.attr("href"),imgSize:t.attr("data-image-size"),group:t.attr("data-group"),data:t.attr("data-data")}:t.hasClass("js-open-popup-video")&&(e={vid:t.attr("href"),img:t.attr("data-preview"),imgSize:t.attr("data-preview-size"),group:t.attr("data-group"),data:t.attr("data-data")}),a.media(t,e)}}};$(document).ready(function(){if($("body").on("click",".js-open-popup-image",function(){var i={img:$(this).attr("href"),imgSize:$(this).attr("data-image-size"),group:$(this).attr("data-group"),data:$(this).attr("data-data")};return Popup.media(this,i,!0),!1}),$("body").on("click",".js-open-popup-video",function(){var i={vid:$(this).attr("href"),img:$(this).attr("data-preview"),imgSize:$(this).attr("data-preview-size"),group:$(this).attr("data-group"),data:$(this).attr("data-data")};return Popup.media(this,i,!0),!1}),$("body").on("click",".popup-media__play",function(){return Popup.play(),!1}),$("body").on("click",".popup-media__arr",function(){return Popup.next($(this).attr("data-dir")),!1}),$("body").on("click",".js-open-msg-popup",function(){return Popup.message("#message-popup",'Это всплывашка с сообщением.<br> вызов: <span class="c-red">Popup.message("#id", "Текст или html");</span>',function(){alert("После закрытия")}),!1}),$("body").on("click",".popup__close",function(){return Popup.hide(),!1}),$("body").on("click",".popup",function(i){$(i.target).closest(".popup__window").length||Popup.hide()}),window.location.hash){var i=window.location.hash;$(i).length&&$(i).hasClass("popup__window")&&Popup.show(i)}});
