var winW,winH;!function(){"use strict";document.documentElement.setAttribute("data-useragent",navigator.userAgent),winW=window.innerWidth,winH=window.innerHeight,window.addEventListener("winResized",function(){winW=window.innerWidth,winH=window.innerHeight});try{new CustomEvent("IE has CustomEvent, but doesn't support constructor")}catch(t){window.CustomEvent=function(t,e){var n;return e=e||{bubbles:!1,cancelable:!1,detail:void 0},n=document.createEvent("CustomEvent"),n.initCustomEvent(t,e.bubbles,e.cancelable,e.detail),n},CustomEvent.prototype=Object.create(window.Event.prototype)}var t=new CustomEvent("winResized"),e=!0;window.addEventListener("resize",function(){e&&(e=!1,setTimeout(function(){window.dispatchEvent(t),e=!0},1021))}),Element.prototype.closest||function(t){t.matches=t.matches||t.mozMatchesSelector||t.msMatchesSelector||t.oMatchesSelector||t.webkitMatchesSelector,t.closest=t.closest||function(t){return this?this.matches(t)?this:this.parentElement?this.parentElement.closest(t):null:null}}(Element.prototype)}();
...
function CustomFile(){function e(e,t){var s=l.$field.find(".custom-file__preview").eq(t);if(e.type.match("image")){var a=new FileReader;a.onload=function(e){s.html('<img src="'+e.target.result+'" class="cover-img">'),setTimeout(function(){coverImg(".custom-file__item")},721)},a.readAsDataURL(e)}else s.html('<img src="images/preview.svg" class="full-width-img">')}function t(t){var s=$(t),a=s[0].files,o=s.siblings(".custom-file__items");l.$field=s.closest(".custom-file"),o.empty();for(var c=0;c<a.length;c++)o.append('<div class="custom-file__item"><div class="custom-file__preview cover-img-wrap"></div><div class="custom-file__name">'+a[c].name+"</div></div>"),e(a[c],c)}var l=this;l.$field=null,$("body").on("change",'input[type="file"]',function(){t(this)})}var CustomPlaceholder={init:function(e){var t=this;$(e).each(function(e){if(_$=$(this),placeholder=_$.attr("placeholder"),inpId=_$.attr("id"),void 0!=placeholder){var l=_$.parent(),s=inpId||"placeholder-index-"+e;l.prepend('<label for="'+s+'" class="custom-placeholder">'+placeholder+"</label>"),_$.removeAttr("placeholder").attr("id",s)}""!=_$.val()&&t.hidePlaceholder(_$,!0)}),$("body").on("focus",e,function(){t.hidePlaceholder(this,!0)}),$("body").on("blur",e,function(){t.hidePlaceholder(this,!1)})},hidePlaceholder:function(e,t){var l=$(e),s=$('label[for="'+l.attr("id")+'"]');s.length&&(t?s.css({textIndent:"-9999px",paddingLeft:0,paddingRight:0}):""==l.val()&&s.css({textIndent:0,paddingLeft:"",paddingRight:""}))}},CustomSelect={$field:null,close:function(){$(".custom-select").removeClass("custom-select_opened"),$(".custom-select__options").slideUp(221).find("li").removeClass("hover")},open:function(e){$(e).closest(".custom-select").addClass("custom-select_opened").find(".custom-select__options").slideDown(221).animate({scrollTop:0},0)},selectVal:function(e){var t=this,l=$(e),s=l.closest(".custom-select"),a=s.find(".custom-select__button"),o=s.find(".custom-select__input");if(s.hasClass("custom-select_multiple")){var c=[],i=[],n=s.find(".custom-select__multiple-inputs");if(l.hasClass("custom-select__val_checked")?l.removeClass("custom-select__val_checked"):l.addClass("custom-select__val_checked"),s.find(".custom-select__val_checked").each(function(e){var t=$(this);c[e]=t.html(),i[e]=void 0!=t.attr("data-value")?t.attr("data-value"):t.html()}),c.length){if(a.html(c.join(", ")),o.val(i[0]),n.empty(),i.length>1)for(var d=1;d<i.length;d++)n.append('<input type="hidden" name="'+o.attr("name")+'" value="'+i[d]+'">')}else a.html(a.attr("data-placeholder")),o.val(""),t.close()}else{var c=l.html(),i=void 0!=l.attr("data-value")?l.attr("data-value"):l.html();s.find(".custom-select__val").removeClass("custom-select__val_checked"),l.addClass("custom-select__val_checked"),a.html(c),o.val(i),CustomPlaceholder.hidePlaceholder(o,!0),t.close()}s.find(".custom-select__val").each(function(){if(_$=$(this),targetElements=_$.attr("data-target-elements"),targetElements){var e=$(targetElements);_$.hasClass("custom-select__val_checked")?e.show():e.hide()}}),o.hasClass("var-height-textarea__textarea")&&varHeightTextarea.setHeight(o),s.addClass("custom-select_changed"),ValidateForm.select(o)},autocomplete:function(e){var t=$(e).closest(".custom-select"),l=$(e).val(),s=!1,a=new RegExp(l,"gi");t.find(".custom-select__val").each(function(){var e=$(this);e.html().match(a)?(e.parent().removeClass("hidden"),s=!0):e.parent().addClass("hidden")}),s||t.find(".custom-select__options li").removeClass("hidden")},setOptions:function(e,t,l,s){for(var a=$(e).find(".custom-select__options"),o=0;o<t.length;o++)a.append('<li><button type="button" class="custom-select__val" data-value="'+t[o][l]+'">'+t[o][s]+"</button></li>")},keyboard:function(e,t){var l=$(e).find(".custom-select__options"),s=l.find("li.hover");switch(t){case 40:if(s.length){var a=s.nextAll("li:visible").first();a.length&&(s.removeClass("hover"),a.addClass("hover"),l.stop().animate({scrollTop:l.scrollTop()+a.position().top},121))}else l.find("li:visible").first().addClass("hover");break;case 38:var a=s.prevAll("li:visible").first();a.length&&(s.removeClass("hover"),a.addClass("hover"),l.stop().animate({scrollTop:l.scrollTop()+a.position().top},121));break;case 13:this.selectVal(s.find(".custom-select__val"))}},fillAcHead:function(){var e=this;$(".custom-select__autocomplete").each(function(){var t=$(this),l=t.closest(".custom-select").find(".custom-select__val_checked");l.length&&e.selectVal(l)})},init:function(e){var t=this;$(e).each(function(){for(var e=$(this),t=e.find("option"),l=e.parent(),s="",a=void 0!=e.attr("data-required")?' data-required="'+e.attr("data-required")+'" ':"",o="autocomplete"==e.attr("data-type")?'<input type="text" name="'+e.attr("name")+'"'+a+'placeholder="'+e.attr("data-placeholder")+'" class="custom-select__input custom-select__autocomplete form__text-input" value="">':'<button type="button" data-placeholder="'+e.attr("data-placeholder")+'" class="custom-select__button">'+e.attr("data-placeholder")+"</button>",c={class:void 0!=e.attr("multiple")?" custom-select_multiple":"",inpDiv:void 0!=e.attr("multiple")?'<div class="custom-select__multiple-inputs"></div>':""},i="autocomplete"!=e.attr("data-type")?'<input type="hidden" name="'+e.attr("name")+'"'+a+'class="custom-select__input" value="">':"",n=0;n<t.length;n++){var d=$(t[n]);s+='<li><button type="button" class="custom-select__val"'+(void 0!=d.attr("value")?' data-value="'+d.attr("value")+'"':"")+(void 0!=d.attr("data-target-elements")?' data-target-elements="'+d.attr("data-target-elements")+'"':"")+">"+d.html()+"</button></li>"}l.prepend('<div class="custom-select'+c.class+'">'+o+'<ul class="custom-select__options">'+s+"</ul>"+i+c.inpDiv+"</div>"),e.remove()}),$("body").on("click",".custom-select__button",function(){return $(this).closest(".custom-select").hasClass("custom-select_opened")?t.close():(t.fillAcHead(),t.close(),t.open(this)),!1}).on("click",".custom-select__val",function(){return t.selectVal(this),!1}).on("focus",".custom-select__autocomplete",function(){$(this).closest(".custom-select").hasClass("custom-select_opened")||(t.fillAcHead(),t.close(),t.open(this))}).on("input",".custom-select__autocomplete",function(){t.autocomplete(this),$(this).closest(".custom-select").hasClass("custom-select_opened")||t.open(this)}).on("keydown",".custom-select_opened",function(e){if(40==e.keyCode||38==e.keyCode||13==e.keyCode)return t.keyboard(this,e.keyCode),!1}),$(document).on("click","body",function(e){$(e.target).closest(".custom-select_opened").length||(t.fillAcHead(),t.close())})}},varHeightTextarea={setHeight:function(e){var t=$(e),l=t.val(),s=t.parent().find(".var-height-textarea__mirror");newValue=l.replace(/\n/g,"<br>"),s.html(newValue+"&nbsp;")},init:function(){var e=this;$("body").on("input",".var-height-textarea__textarea",function(){e.setHeight(this)})}};$(document).ready(function(){CustomPlaceholder.init('input[type="text"], input[type="password"], textarea'),CustomSelect.init("select"),CustomFile(),varHeightTextarea.init()});
...
$(document).ready(function(){$("label").each(function(t){var e=$(this),i=e.siblings("label"),a=e.siblings("input, textarea"),n=a.attr("id");if(!e.attr("for")){var r=n||"keylabel-"+t;e.attr("for",r),i.attr("for",r),a.attr("id",r)}}),$("body").on("change",'input[type="checkbox"]',function(){var t=$(this),e=t.attr("data-target-elements");if(e){var i=$(e);t.prop("checked")?i.show():i.hide()}}),$("body").on("change",'input[type="radio"]',function(){var t=$(this).attr("name");$('input[type="radio"][name="'+t+'"]').each(function(){var t=$(this),e=t.attr("data-target-elements");if(e){var i=$(e);t.prop("checked")?i.show():i.hide()}})}),$("body").on("click",".form__button",function(){var t=$(this),e=t.attr("data-next-fieldset-item");if(e){var i=$(e),a=t.closest(".fieldset__item");ValidateForm.validate(a)&&(a.addClass("fieldset__item_hidden"),i.removeClass("fieldset__item_hidden"))}})});var Form;!function(){"use strict";Form=function(t){function e(t){t.preventDefault(),this.onSubmit.bind(i)()}this.onSubmit=null;var i=document.querySelector(t);i&&i.addEventListener("submit",e.bind(this))}}();
...
var ValidateForm;!function(){"use strict";ValidateForm={$input:null,errorTip:function(t,r){function i(){a.attr("data-first-error-text")||a.attr("data-first-error-text",a.html())}var e=this,n=e.$input.closest(".form__field"),a=n.find(".form__error-tip");if(t)switch(n.addClass("form__field_error"),r){case 2:i(),a.html(a.attr("data-second-error-text"));break;case 3:i(),a.html(a.attr("data-third-error-text"));break;case"custom":i(),a.html(errorTxt);break;default:a.attr("data-first-error-text")&&a.html(a.attr("data-first-error-text"))}else n.removeClass("form__field_error")},customErrorTip:function(t,r){var i=this;i.$input=t,i.errorTip(!0,"custom",r)},date:function(){var t=this,r=!1;return function(t){var r=new RegExp("^([0-9]{2}).([0-9]{2}).([0-9]{4})$"),i=r.exec(t);if(!i)return!1;var e=new Date,n=new Date(i[3],i[2]-1,i[1]);return n.getMonth()==i[2]-1&&n.getDate()==i[1]&&n.getFullYear()==i[3]&&n.valueOf()<e.valueOf()}(t.$input.val())?t.errorTip(!1):(t.errorTip(!0,2),r=!0),r},email:function(){var t=this,r=!1;return/^[a-z0-9]+[\w\-\.]*@[\w\-]{2,}\.[a-z]{2,6}$/i.test(t.$input.val())?t.errorTip(!1):(t.errorTip(!0,2),r=!0),r},tel:function(){var t=this,r=!1;return/^\+7\([0-9]{3}\)[0-9]{3}-[0-9]{2}-[0-9]{2}$/.test(t.$input.val())?t.errorTip(!1):(t.errorTip(!0,2),r=!0),r},pass:function(){var t=this,r=!1,i=t.$input.attr("data-min-length");return i&&t.$input.val().length<i?(t.errorTip(!0,2),r=!0):t.errorTip(!1),r},select:function(t){var r=this,i=!1;return r.$input=t,r.$input.attr("data-required")&&!r.$input.val().length?(r.errorTip(!0),i=!0):r.errorTip(!1),i},validateOnInput:function(t){var r=this;r.$input=$(t);var i=r.$input.attr("data-type"),e=r.$input.val();r.$input.hasClass("tested")&&(r.$input.attr("data-required")&&!e.length?r.errorTip(!0):e.length&&i?r[i]():r.errorTip(!1))},validateOnBlur:function(t){var r=this;r.$input=$(t),r.$input.addClass("tested");var i=r.$input.attr("data-type"),e=r.$input.val();r.$input.attr("data-required")&&!e.length?r.errorTip(!0):e.length&&i?r[i]():r.errorTip(!1)},file:function(t){var r=this;r.$input=$(t);for(var i=!1,e={type:0,size:0},n=r.$input[0].files,a=r.$input.attr("data-type"),o=+r.$input.attr("data-max-size"),p=0;p<n.length;p++)n[p].type.match(a)||e.type++,n[p].size>o&&e.size++;return e.type?(r.errorTip(!0,2),i=!0):e.size?(r.errorTip(!0,3),i=!0):r.errorTip(!1),i},validate:function(t){var r=this,i=$(t),e=0;return i.find('input[type="text"], input[type="password"], textarea').each(function(){if(r.$input=$(this),!r.$input.is(":hidden")){var t=r.$input.attr("data-type"),i=r.$input.val();r.$input.addClass("tested"),i.length?t&&r[t]()&&e++:r.$input.attr("data-required")?(r.errorTip(!0),e++):r.errorTip(!1)}}),i.find(".custom-select__input").each(function(){r.$input=$(this),r.$input.parent().is(":hidden")||(r.$input.addClass("tested"),r.$input.attr("data-required")&&!r.$input.val().length?(r.errorTip(!0),e++):r.errorTip(!1))}),i.find('input[type="checkbox"]').each(function(){r.$input=$(this),r.$input.is(":hidden")||(r.$input.attr("data-required")&&!r.$input.prop("checked")?(r.errorTip(!0),e++):r.errorTip(!1))}),i.find(".form__chbox-group").each(function(){var t=0,r=$(this);r.is(":hidden")||(r.find('input[type="checkbox"]').each(function(){$(this).prop("checked")&&t++}),t<r.attr("data-min")?(r.addClass("form__chbox-group_error"),e++):r.removeClass("form__chbox-group_error"))}),i.find(".form__radio-group").each(function(){var t=!0,r=$(this);r.closest(".form__field_hidden, .form__fieldset_hidden");r.is(":hidden")||(r.find('input[type="radio"]').each(function(){$(this).prop("checked")&&(t=!1)}),t?(r.addClass("form__radio-group_error"),e++):r.removeClass("form__radio-group_error"))}),i.find('input[type="file"]').each(function(){r.$input=$(this),r.$input.is(":hidden")||(r.$input[0].files.length?r.file(this)&&e++:r.$input.attr("data-required")?(r.errorTip(!0),e++):r.errorTip(!1))}),i.find(".form__text-input[data-pass-compare-input]").each(function(){r.$input=$(this);var t=r.$input.val();t.length&&(t!==$(r.$input.attr("data-pass-compare-input")).val()?(r.errorTip(!0,2),e++):r.errorTip(!1))}),e?i.addClass("form_error"):i.removeClass("form_error"),!e},actSubmitBtn:function(t,r){var i=$(t).find('button[type="submit"], input[type="submit"]');i.is(":hidden")||(r?i.prop("disabled",!1):i.prop("disabled",!0))},clearForm:function(t){var r=$(t);r.find('input[type="text"], input[type="password"], textarea').val(""),r.find(".custom-placeholder").attr("style",""),r.find(".form__textarea-mirror").html("")},submit:function(t,r){var i=this;$(t).addClass("form_sending"),r(t,function(r){r=r||{},i.actSubmitBtn(t,r.unlockButton),1==r.clearForm&&i.clearForm(t),$(t).removeClass("form_sending")})},init:function(t,r){var i=this;$("body").on("input",t+' input[type="text"],'+t+' input[type="password"],'+t+" textarea",function(){i.validateOnInput(this)}).on("blur",t+' input[type="text"],'+t+' input[type="password"],'+t+" textarea",function(){i.validateOnBlur(this)}).on("change",t+' input[type="file"]',function(){i.file(this)}).on("submit",t,function(){var t=this;if(i.validate(t)){if(i.actSubmitBtn(t,!1),void 0===r)return!0;i.submit(t,r)}return!1})}}}();
