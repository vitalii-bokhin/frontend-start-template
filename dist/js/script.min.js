...
$(document).ready(function(){$("label").each(function(t){var e=$(this),i=e.siblings("label"),r=e.siblings("input, textarea"),a=r.attr("id");if(!e.attr("for")){var n=a||"keylabel-"+t;e.attr("for",n),i.attr("for",n),r.attr("id",n)}}),$("body").on("change",'input[type="checkbox"]',function(){var t=$(this),e=t.attr("data-target-elements");if(e){var i=$(e);t.prop("checked")?i.show():i.hide()}}),$("body").on("change",'input[type="radio"]',function(){var t=$(this).attr("name");$('input[type="radio"][name="'+t+'"]').each(function(){var t=$(this),e=t.attr("data-target-elements");if(e){var i=$(e);t.prop("checked")?i.show():i.hide()}})}),$("body").on("click",".form__button",function(){var t=$(this),e=t.attr("data-next-fieldset-item");if(e){var i=$(e),r=t.closest(".fieldset__item");ValidateForm.validate(r)&&(r.addClass("fieldset__item_hidden"),i.removeClass("fieldset__item_hidden"))}})});var Form;!function(){"use strict";Form=function(t){function e(){var t=a.querySelectorAll('input[type="text"], input[type="password"], textarea');t.forEach(function(t){t.value=""});var t=a.querySelectorAll(".custom-placeholder");t.forEach(function(t){t.removeAttribute("style")})}function i(t){a.querySelectorAll('button[type="submit"], input[type="submit"]').forEach(function(e){isHidden(e)||(t?e.removeAttribute("disabled"):e.setAttribute("disabled","disable"))})}function r(t){ValidateForm.submit(a)?(i(!1),a.classList.add("form_sending"),this.onSubmit&&(t.preventDefault(),this.onSubmit(a,function(t){t=t||{},i(t.unlockSubmitButton),a.classList.remove("form_sending"),1==t.clearForm&&e()})),a.classList.remove("form_error")):(t.preventDefault(),a.classList.add("form_error"))}this.onSubmit=null;var a=document.querySelector(t);a&&(a.addEventListener("submit",r.bind(this)),ValidateForm.init(a))}}();
