...
var winW,winH;!function(){document.documentElement.setAttribute("data-useragent",navigator.userAgent),winW=window.innerWidth,winH=window.innerHeight,window.addEventListener("winResized",function(){winW=window.innerWidth,winH=window.innerHeight});try{new CustomEvent("IE has CustomEvent, but doesn't support constructor")}catch(n){window.CustomEvent=function(n,t){var e;return t=t||{bubbles:!1,cancelable:!1,detail:void 0},e=document.createEvent("CustomEvent"),e.initCustomEvent(n,t.bubbles,t.cancelable,t.detail),e},CustomEvent.prototype=Object.create(window.Event.prototype)}var n=new CustomEvent("winResized"),t=!0;window.addEventListener("resize",function(){t&&(t=!1,setTimeout(function(){window.dispatchEvent(n),t=!0},1021))})}();
