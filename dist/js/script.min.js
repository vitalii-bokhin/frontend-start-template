...
function CustomFile(){function e(e,t){var s=l.$field.find(".custom-file__preview").eq(t);if(e.type.match("image")){var i=new FileReader;i.onload=function(e){s.html('<img src="'+e.target.result+'" class="cover-img">'),setTimeout(function(){coverImg(".custom-file__item")},721)},i.readAsDataURL(e)}else s.html('<img src="images/preview.svg" class="full-width-img">')}function t(t){var s=$(t),i=s[0].files,c=s.siblings(".custom-file__items");l.$field=s.closest(".custom-file"),c.empty();for(var o=0;o<i.length;o++)c.append('<div class="custom-file__item"><div class="custom-file__preview cover-img-wrap"></div><div class="custom-file__name">'+i[o].name+"</div></div>"),e(i[o],o)}var l=this;l.$field=null,$("body").on("change",'input[type="file"]',function(){t(this)})}var CustomPlaceholder={init:function(e){document.querySelectorAll(e).forEach(function(e,t){if(e.placeholder){var l=e.id?e.id:"placeholder-index-"+t,s=document.createElement("label");s.htmlFor=l,s.className="custom-placeholder",s.innerHTML=e.placeholder,e.parentElement.insertBefore(s,e),e.removeAttribute("placeholder"),e.id||(e.id=l)}""!=e.value&&this.hidePlaceholder(e,!0)}),document.addEventListener("focus",function(t){var l=t.target.closest(e);l&&this.hidePlaceholder(l,!0)}.bind(this),!0),document.addEventListener("blur",function(t){var l=t.target.closest(e);l&&this.hidePlaceholder(l,!1)}.bind(this),!0)},hidePlaceholder:function(e,t){var l=document.querySelector('label[for="'+e.id+'"]');if(l){var s=l.style;t?(s.textIndent="-9999px",s.paddingLeft="0",s.paddingRight="0"):""==e.value&&(s.textIndent="0",s.paddingLeft="",s.paddingRight="")}}},CustomSelect={field:null,close:function(){document.querySelectorAll(".custom-select").forEach(function(e){e.classList.remove("custom-select_opened")}),document.querySelectorAll(".custom-select__options li").forEach(function(e){e.classList.remove("hover")})},open:function(){this.field.classList.add("custom-select_opened"),this.field.querySelector(".custom-select__options").scrollTop=0},selectMultipleVal:function(e,t,l){var s=[],i=[],c=this.field.querySelector(".custom-select__multiple-inputs");if(e.classList.toggle("custom-select__val_checked"),this.field.querySelectorAll(".custom-select__val_checked").forEach(function(e,t){s[t]=e.innerHTML,i[t]=e.hasAttribute("data-value")?e.getAttribute("data-value"):e.innerHTML}),s.length){if(t.innerHTML=s.join(", "),l.value=i[0],c.innerHTML="",i.length>1)for(var o=1;o<i.length;o++){var a=document.createElement("input");a.type="hidden",a.name=l.name,a.value=i[o],c.appendChild(a)}}else t.innerHTML=t.getAttribute("data-placeholder"),l.value="",this.close()},targetAction:function(){this.field.querySelectorAll(".custom-select__val").forEach(function(e){e.hasAttribute("data-target-elements")&&(document.querySelector(e.getAttribute("data-target-elements")).style.display=e.classList.contains("custom-select__val_checked")?"block":"none")})},selectVal:function(e){var t=this.field.querySelector(".custom-select__button"),l=this.field.querySelector(".custom-select__input");if(this.field.classList.contains("custom-select_multiple"))this.selectMultipleVal(e,t,l);else{var s=e.innerHTML,i=e.hasAttribute("data-value")?e.getAttribute("data-value"):e.innerHTML;this.field.querySelectorAll(".custom-select__val").forEach(function(e){e.classList.remove("custom-select__val_checked")}),e.classList.add("custom-select__val_checked"),t&&(t.innerHTML=s),l.value=i,this.close()}this.targetAction(),this.field.classList.add("custom-select_changed"),ValidateForm.select(l)},autocomplete:function(e){var t=$(e).closest(".custom-select"),l=$(e).val(),s=!1,i=new RegExp(l,"gi");t.find(".custom-select__val").each(function(){var e=$(this);e.html().match(i)?(e.parent().removeClass("hidden"),s=!0):e.parent().addClass("hidden")}),s||t.find(".custom-select__options li").removeClass("hidden")},setOptions:function(e,t,l,s){for(var i=$(e).find(".custom-select__options"),c=0;c<t.length;c++)i.append('<li><button type="button" class="custom-select__val" data-value="'+t[c][l]+'">'+t[c][s]+"</button></li>")},keyboard:function(e,t){var l=$(e).find(".custom-select__options"),s=l.find("li.hover");switch(t){case 40:if(s.length){var i=s.nextAll("li:visible").first();i.length&&(s.removeClass("hover"),i.addClass("hover"),l.stop().animate({scrollTop:l.scrollTop()+i.position().top},121))}else l.find("li:visible").first().addClass("hover");break;case 38:var i=s.prevAll("li:visible").first();i.length&&(s.removeClass("hover"),i.addClass("hover"),l.stop().animate({scrollTop:l.scrollTop()+i.position().top},121));break;case 13:this.selectVal(s.find(".custom-select__val"))}},fillAcHead:function(){var e=this;document.querySelectorAll(".custom-select__autocomplete").forEach(function(t){var l=t.closest(".custom-select").querySelectorAll(".custom-select__val_checked");l&&l.forEach(function(t){e.selectVal(t)})})},init:function(e){var t=this;$(e).each(function(){for(var e=$(this),t=e.find("option"),l=e.parent(),s="",i=void 0!=e.attr("data-required")?' data-required="'+e.attr("data-required")+'" ':"",c="autocomplete"==e.attr("data-type")?'<input type="text" name="'+e.attr("name")+'"'+i+'placeholder="'+e.attr("data-placeholder")+'" class="custom-select__input custom-select__autocomplete form__text-input" value="">':'<button type="button" data-placeholder="'+e.attr("data-placeholder")+'" class="custom-select__button">'+e.attr("data-placeholder")+"</button>",o={class:void 0!=e.attr("multiple")?" custom-select_multiple":"",inpDiv:void 0!=e.attr("multiple")?'<div class="custom-select__multiple-inputs"></div>':""},a="autocomplete"!=e.attr("data-type")?'<input type="hidden" name="'+e.attr("name")+'"'+i+'class="custom-select__input" value="">':"",n=0;n<t.length;n++){var r=$(t[n]);s+='<li><button type="button" class="custom-select__val"'+(void 0!=r.attr("value")?' data-value="'+r.attr("value")+'"':"")+(void 0!=r.attr("data-target-elements")?' data-target-elements="'+r.attr("data-target-elements")+'"':"")+">"+r.html()+"</button></li>"}l.prepend('<div class="custom-select'+o.class+'">'+c+'<ul class="custom-select__options">'+s+"</ul>"+a+o.inpDiv+"</div>"),e.remove()}),document.addEventListener("click",function(e){var t=e.target.closest(".custom-select__button");t&&(this.field=t.closest(".custom-select"),this.field.classList.contains("custom-select_opened")?this.close():(this.fillAcHead(),this.close(),this.open()))}.bind(this)),document.addEventListener("click",function(e){var t=e.target.closest(".custom-select__val");t&&(this.field=t.closest(".custom-select"),this.selectVal(t))}.bind(this)),document.addEventListener("focus",function(e){var t=e.target.closest(".custom-select__autocomplete");t&&(this.field=t.closest(".custom-select"),this.field.classList.contains("custom-select_opened")||(this.fillAcHead(),this.close(),this.open()))}.bind(this),!0),document.addEventListener("input",function(e){var t=e.target.closest(".custom-select__autocomplete");t&&(this.field=t.closest(".custom-select"),this.autocomplete(t),this.field.classList.contains("custom-select_opened")||this.open())}.bind(this)),$("body").on("keydown",".custom-select_opened",function(e){if(40==e.keyCode||38==e.keyCode||13==e.keyCode)return t.keyboard(this,e.keyCode),!1}),$(document).on("click","body",function(e){$(e.target).closest(".custom-select_opened").length||(t.fillAcHead(),t.close())})}},varHeightTextarea={setHeight:function(e){var t=$(e),l=t.val(),s=t.parent().find(".var-height-textarea__mirror");newValue=l.replace(/\n/g,"<br>"),s.html(newValue+"&nbsp;")},init:function(){var e=this;$("body").on("input",".var-height-textarea__textarea",function(){e.setHeight(this)})}};$(document).ready(function(){CustomPlaceholder.init('input[type="text"], input[type="password"], textarea'),CustomSelect.init("select"),CustomFile(),varHeightTextarea.init()});
