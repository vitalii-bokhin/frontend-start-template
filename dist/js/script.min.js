...
var ValidateForm;!function(){"use strict";ValidateForm={input:null,errorTip:function(t,r){var e=this.input.closest(".form__field"),i=e.querySelector(".form__error-tip");t?(e.classList.add("form__field_error"),r&&(i.getAttribute("data-error-text")||i.setAttribute("data-error-text",i.innerHTML),i.innerHTML=i.getAttribute("data-error-text-"+r))):e.classList.remove("form__field_error")},customErrorTip:function(t,r){var e=this;e.$input=t,e.errorTip(!0,"custom",r)},date:function(){var t=!1;return function(t){var r=new RegExp("^([0-9]{2}).([0-9]{2}).([0-9]{4})$"),e=r.exec(t);if(!e)return!1;var i=new Date,a=new Date(e[3],e[2]-1,e[1]);return a.getMonth()==e[2]-1&&a.getDate()==e[1]&&a.getFullYear()==e[3]&&a.valueOf()<i.valueOf()}(this.input.value)?this.errorTip(!1):(this.errorTip(!0,2),t=!0),t},email:function(){var t=!1;return/^[a-z0-9]+[\w\-\.]*@[\w\-]{2,}\.[a-z]{2,6}$/i.test(this.input.value)?this.errorTip(!1):(this.errorTip(!0,2),t=!0),t},tel:function(){var t=!1;return/^\+7\([0-9]{3}\)[0-9]{3}-[0-9]{2}-[0-9]{2}$/.test(this.input.value)?this.errorTip(!1):(this.errorTip(!0,2),t=!0),t},pass:function(){var t=!1,r=this.input.getAttribute("data-min-length");return r&&this.input.value.length<r?(this.errorTip(!0,2),t=!0):this.errorTip(!1),t},select:function(t){var r=this,e=!1;return r.$input=t,r.$input.attr("data-required")&&!r.$input.val().length?(r.errorTip(!0),e=!0):r.errorTip(!1),e},validateOnInputOrBlur:function(t){var r=t.target.closest('input[type="text"], input[type="password"], textarea');if(r){if(this.input=r,"blur"==t.type)r.setAttribute("data-tested","true");else if("input"==t.type&&!r.getAttribute("data-tested"))return;var e=r.getAttribute("data-type"),i=r.value;r.getAttribute("data-required")&&!i.length?this.errorTip(!0):i.length&&e?this[e]():this.errorTip(!1)}},file:function(t){var r=this;r.$input=$(t);for(var e=!1,i={type:0,size:0},a=r.$input[0].files,n=r.$input.attr("data-type"),u=+r.$input.attr("data-max-size"),o=0;o<a.length;o++)a[o].type.match(n)||i.type++,a[o].size>u&&i.size++;return i.type?(r.errorTip(!0,2),e=!0):i.size?(r.errorTip(!0,3),e=!0):r.errorTip(!1),e},validate:function(t){function r(t){for(var r=!1;t&&t;){var e=getComputedStyle(t);if("none"==e.display||"hidden"==e.visibility||"0"==e.opacity){r=!0;break}t=t.parentElement}return r}for(var e=0,i=t.querySelectorAll('input[type="text"], input[type="password"], textarea'),a=0;a<i.length;a++){var n=i[a];if(!r(n)){this.input=n,n.setAttribute("data-tested","true");var u=n.getAttribute("data-type");n.value.length?u&&this[u]()&&e++:n.getAttribute("data-required")?(this.errorTip(!0),e++):this.errorTip(!1)}}for(var i=t.querySelectorAll(".custom-select__input"),a=0;a<i.length;a++){var n=i[a];r(n)||(this.input=n,n.setAttribute("data-tested","true"),n.getAttribute("data-required")&&!n.value.length?(this.errorTip(!0),e++):this.errorTip(!1))}for(var i=t.querySelectorAll('input[type="checkbox"]'),a=0;a<i.length;a++){var n=i[a];r(n)||(this.input=n,console.dir(n),n.getAttribute("data-required")&&!n.checked?(this.errorTip(!0),e++):this.errorTip(!1))}for(var o=t.querySelectorAll(".form__chbox-group"),a=0;a<o.length;a++){var p=o[a],s=0;if(!r(p)){var i=p.querySelectorAll('input[type="checkbox"]');i.forEach(function(t){t.checked&&s++}),s<p.getAttribute("data-min")?(p.classList.add("form__chbox-group_error"),e++):p.classList.remove("form__chbox-group_error")}}for(var o=t.querySelectorAll(".form__radio-group"),a=0;a<o.length;a++){var p=o[a],l=!1;if(!r(p)){var i=p.querySelectorAll('input[type="radio"]');i.forEach(function(t){t.checked&&(l=!0)}),l?p.classList.remove("form__radio-group_error"):(p.classList.add("form__radio-group_error"),e++)}}return $form.find('input[type="file"]').each(function(){_.$input=$(this),_.$input.is(":hidden")||(_.$input[0].files.length?_.file(this)&&e++:_.$input.attr("data-required")?(_.errorTip(!0),e++):_.errorTip(!1))}),$form.find(".form__text-input[data-pass-compare-input]").each(function(){_.$input=$(this);var t=_.$input.val();t.length&&(t!==$(_.$input.attr("data-pass-compare-input")).val()?(_.errorTip(!0,2),e++):_.errorTip(!1))}),e?$form.addClass("form_error"):$form.removeClass("form_error"),!e},actSubmitBtn:function(t,r){var e=$(t).find('button[type="submit"], input[type="submit"]');e.is(":hidden")||(r?e.prop("disabled",!1):e.prop("disabled",!0))},clearForm:function(t){var r=$(t);r.find('input[type="text"], input[type="password"], textarea').val(""),r.find(".custom-placeholder").attr("style",""),r.find(".form__textarea-mirror").html("")},submit:function(t){return this.validate(t)},init:function(t){t.addEventListener("input",this.validateOnInputOrBlur.bind(this)),t.addEventListener("blur",this.validateOnInputOrBlur.bind(this),!0)}}}();
